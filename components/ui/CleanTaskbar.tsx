  ...
  const menus: MenuData[] = [
    {
      ...
      items: [
        ...
        { divider: true },
        { label: 'Bitcoin Writer Pro...', action: () => window.dispatchEvent(new CustomEvent('openSubscriptionModal')) },
        { label: 'Add BSV Balance...', action: () => window.dispatchEvent(new CustomEvent('openTopUpModal')) },
        { divider: true },
