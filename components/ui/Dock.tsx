...
const Dock: React.FC<DockProps> = ({ currentApp = 'bitcoin-writer' }) => {
  ...
  const dockApps: DockApp[] = [
    ...
    { name: 'Bitcoin Writer', icon: FileText, color: 'rainbow', url: 'https://thebitcoincorporation.website', current: currentApp === 'bitcoin-writer' },
