...
import "./DocumentEditor.css"; * Copyright (C) 2025 The Bitcoin Corporation LTD
 *
...
import PublishSettingsModal, { PublishSettings } from '../modals/PublishSettingsModal';
import SaveToBlockchainModal, { BlockchainSaveOptions } from '../modals/SaveToBlockchainModal';
import TokenizeModal, { TokenizationOptions } from '../modals/TokenizeModal';
        ...
        <div className="toolbar-mobile">
          <div className="mobile-main-actions">
            ...
            >
              ...
              Save to Chain {wordCount > 0 && `(${currentPrice})`}
            </button>
...
// Style override to align paper to left edge
