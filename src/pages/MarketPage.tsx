  ...
  const featuredContent: FeaturedContent[] = [
    {
      ...
      description: 'Discover how Bitcoin Writer transforms content creation into tokenized assets, enabling writers to encrypt, publish, and sell shares in their work on the blockchain',
      author: 'b0ase',
      authorHandle: '@b0ase',
    ...
    },
    {
      ...
      readTime: 10,
      engagement: 1950,
      thumbnail: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=400&h=250&fit=crop&crop=center',
      price: 0.008,
      isTokenized: true,
      trending: false
    },
