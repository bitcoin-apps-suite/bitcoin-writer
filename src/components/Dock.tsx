...
import { Wallet, Mail, Music, FileText, HardDrive, Calendar, Search, Table, Share2, Briefcase, Store, Wifi, Volume2, Battery, Clock, TrendingUp, Building2, Shield, Palette, GraduationCap, Paintbrush, Video, Twitter } from 'lucide-react';
import './Dock.css';
...
const Dock: React.FC = () => {
  ...
  const dockApps: DockApp[] = [
    ...
    { name: 'Bitcoin Twitter', icon: Twitter, color: 'text-sky-400', current: true },
  ];
